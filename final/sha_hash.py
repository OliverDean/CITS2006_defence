...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Walk a directory and hash its files.')
    parser.add_argument('directory', type=str, help='The directory to walk through and hash files')
    args = parser.parse_args()

    walk_directory_and_hash(args.directory)